...
class Models(QtWidgets.QWidget):
    ...
    def setup_ui(self):
        ...
        self.synthseg_like = QtWidgets.QCheckBox("SynthSeg-like")
        self.gridLayout.addWidget(self.synthseg_like, 4, 0, 1, 1)

        self.tumor = QtWidgets.QCheckBox("tumor")
        self.gridLayout.addWidget(self.tumor, 4, 1, 1, 1)

        self.wm_parcellation = QtWidgets.QCheckBox("wm_parcellation")
        self.gridLayout.addWidget(self.wm_parcellation, 5, 0, 1, 1)

        self.wm_hyperintensity = QtWidgets.QCheckBox("wm_hyperintensity")
        self.gridLayout.addWidget(self.wm_hyperintensity, 5, 1, 1, 1)
